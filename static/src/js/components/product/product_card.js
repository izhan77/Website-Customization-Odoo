odoo.define("website_customizations.product_card", function (require) {
  "use strict";

  // Basic console log
  console.log("Product card module loaded");

  // Safely try to get dependencies
  let publicWidget, CartManager;
  try {
    publicWidget = require("web.public.widget");
    CartManager = require("website_customizations.cart_manager");
  } catch (e) {
    console.log("Dependencies not available:", e);
    return {}; // Exit early if dependencies not available
  }
